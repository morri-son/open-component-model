...
require (
	...
	ocm.software/open-component-model/cli v0.0.0-20260121092455-5a30258635be
...
require (
	...
	ocm.software/open-component-model/bindings/go/input/utf8 v0.0.0-20260121092455-5a30258635be // indirect
