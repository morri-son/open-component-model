...
func signingIdentity() runtime.Identity {
	...
	id.SetType(runtime.NewVersionedType(v1alpha1.SignConfigType, v1alpha1.Version))
	return id
}

func verifyingIdentity() runtime.Identity {
	id := runtime.Identity{IdentityAttributeAlgorithm: v1alpha1.AlgorithmSigstore}
	id.SetType(runtime.NewVersionedType(v1alpha1.VerifyConfigType, v1alpha1.Version))
	return id
}
