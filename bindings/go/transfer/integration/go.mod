...
require (
	...
	ocm.software/open-component-model/bindings/go/helm v0.0.0-20260429073711-304fed31a996 // indirect
	ocm.software/open-component-model/bindings/go/signing v0.0.0-20260429073711-304fed31a996 // indirect
