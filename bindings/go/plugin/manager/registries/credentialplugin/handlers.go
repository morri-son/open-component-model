...
// GetConsumerIdentityHandlerFunc is a convenience wrapper for the GetConsumerIdentity contract method.
...
// ResolveHandlerFunc is a convenience wrapper for the Resolve contract method.
