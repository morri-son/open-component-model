...
// will construct a list of endpoint handlers. Once completed, MarshalJSON can be used to construct
// the supported endpoint list to give back to the plugin manager.
