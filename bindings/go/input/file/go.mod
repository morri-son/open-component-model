...
require (
	...
	ocm.software/open-component-model/bindings/go/configuration v0.0.11 // indirect
	...
	ocm.software/open-component-model/bindings/go/descriptor/runtime v0.0.0-20260320161847-270a2281273c // indirect
